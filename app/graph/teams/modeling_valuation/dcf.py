...
from app.prompts.modeling_valuation_prompts import DCF_PROMPT


class DCFAgent(BaseAnalysisAgent):
    name = "dcf"

    async def analyze(self, state: FinancialAnalysisState) -> AgentOutput:
        llm = get_llm()
        response = await llm.ainvoke([
            SystemMessage(content=DCF_PROMPT),
        ...
        return AgentOutput(
            ...
            confidence=0.80,
            metadata={"team": "modeling_valuation", "model_type": "dcf"},
        )
